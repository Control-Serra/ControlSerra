...
**Resumo do Projeto**
--
  O projeto será um sistema de gerenciamento de uma serralheria onde teremos o controle de estoque, criação de orçamento, e relatórios de materiais e de produtos. O sistema iniciará com uma tela de login, que permitirá o acesso às demais telas do projeto, com diversas telas de cadastro para fornecedores e clientes. A comunicação entre as telas dentro do sistema será feita através de uma barra de navegação.

  Primeiramente o sistema possuirá uma tela para visualizar, alterar e criar orçamentos, as quais permite calcular os gastos para cada serviço. Um mesmo cliente poderá ter vários orçamentos ligados a ele, e a partir dos dados inseridos nesta tela o usuário poderá gerar um relatório em forma de impressão ou PDF, o qual poderá ser enviado para os seus clientes. Cada orçamento é numerado e indexado para facilitar a gestão e pesquisa de dados para a tomada de decisão.
  ...
  Haverá telas para cadastro de clientes, fornecedores e funcionários, em que teremos os dados básicos, como nomes, endereços, contatos, entre outros. 
